...
- **Electrodynamics**
  - Calculation of EM fields and relativistically charged particle dynamics, plasma physics and electromagnetic wave propagation in biological tissues (e.g., $B_1$ field distribution in MRI, RF heating). QED is still unnecessary but no harm if you are really interested in the calculation of Feynman diagrams.
